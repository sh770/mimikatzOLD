...
const MSV1_0_PRIMARY_HELPER msv1_0_primaryHelper[] = {
	...
	{FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, LogonDomainName),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, UserName),    FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, isIso),   FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, isNtOwfPassword),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, isLmOwfPassword),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, isShaOwPassword),   FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, unkD),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, NtOwfPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, LmOwfPassword),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, ShaOwPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, DPAPIProtected),  FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_26100, NtOwfPassword)},
	// approach 2
	// {FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, LogonDomainName),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, UserName),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, isIso),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, isNtOwfPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, isLmOwfPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, isShaOwPassword),	0,	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, NtOwfPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, LmOwfPassword), FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, ShaOwPassword),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, DPAPIProtected),	FIELD_OFFSET(MSV1_0_PRIMARY_CREDENTIAL_10_24H2, NtOwfPassword)},
